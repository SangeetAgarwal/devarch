...
## Integration with SpecFrame Workflow

In this SpecFrame fork, skills are generated in two ways:
...
When creating skills as part of a SpecFrame project, follow these standards to ensure consistency and compatibility.
