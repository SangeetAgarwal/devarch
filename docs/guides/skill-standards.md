...
## Integration with SpecArc Workflow

In this SpecArc fork, skills are generated in two ways:
...
When creating skills as part of a SpecArc project, follow these standards to ensure consistency and compatibility.
