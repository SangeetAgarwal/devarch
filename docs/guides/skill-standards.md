...
## Integration with DevArch Workflow

In this DevArch fork, skills are generated in two ways:
...
When creating skills as part of a DevArch project, follow these standards to ensure consistency and compatibility.
