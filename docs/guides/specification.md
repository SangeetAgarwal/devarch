...
This fills a gap in the base SpecArc workflow: without a specification, the LLM has only the folder name to work from, which is too thin a contract for complex work.
...
## Relationship to Other SpecArc Components
